...
- Mastery extends to 400 and 500 owned. Circuits now have eight tiers, ending at 500 on every member.
...
- The first stage of each circuit project unlocks bulk fabrication for that circuit: price growth falls from 14% to 3.5% after the first 100 units. This makes deep ownership practical only after reaching the endgame. The all-circuit project adds a separate permanent production bonus.
