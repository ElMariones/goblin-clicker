...
export function ResourceHeader({ title, subtitle, stats, onOpenAchievements, onOpenPrestige, onOpenCosmetics, onOpenSettings, musicMuted, onToggleMusic, onSkipMusic }: ResourceHeaderProps) {
  const { t } = useI18n();
  return (
