...
const EN = {
  ...
  'research.treeHint': 'Drag / scroll to explore',
  'research.centerTree': 'Center research tree',
  'research.resetView': 'Reset research tree view',
  'research.treeRegion': 'Draggable research tree. Use arrow keys to pan.',
...
const ES: Partial<Record<TranslationKey, string>> = {
  ...
  'research.title': 'Innovaciones de la Madriguera', 'research.eyebrow': 'Investigación', 'research.copy': 'Convierte setas, herramientas robadas y rituales dudosos en mejoras permanentes para este ciclo.', 'research.open': 'Abrir investigación', 'research.treeHint': 'Arrastra / desplázate para explorar', 'research.centerTree': 'Centrar árbol de investigación', 'research.resetView': 'Restablecer vista del árbol', 'research.treeRegion': 'Árbol de investigación arrastrable. Usa las flechas para desplazarte.',
...
const ZH: Partial<Record<TranslationKey, string>> = {
  ...
  'research.title': '巢穴革新', 'research.eyebrow': '研究', 'research.copy': '把蘑菇、偷来的工具和可疑仪式变成本轮永久有效的提升。', 'research.open': '打开研究', 'research.treeHint': '拖动 / 滚动以探索', 'research.centerTree': '居中研究树', 'research.resetView': '重置研究树视图', 'research.treeRegion': '可拖动的研究树。使用方向键平移。',
...
const FR: Partial<Record<TranslationKey, string>> = {
  ...
  'research.title': 'Innovations du Terrier', 'research.eyebrow': 'Recherche', 'research.copy': 'Transformez champignons, outils volés et rituels douteux en gains durables pour ce cycle.', 'research.open': 'Ouvrir la recherche', 'research.treeHint': 'Faites glisser / défiler pour explorer', 'research.centerTree': 'Centrer l’arbre de recherche', 'research.resetView': 'Réinitialiser la vue de l’arbre', 'research.treeRegion': 'Arbre de recherche déplaçable. Utilisez les flèches pour naviguer.',
...
const DE: Partial<Record<TranslationKey, string>> = {
  ...
  'research.title': 'Bau-Innovationen', 'research.eyebrow': 'Forschung', 'research.copy': 'Verwandle Pilze, gestohlene Werkzeuge und fragwürdige Rituale in dauerhafte Vorteile für diesen Brutzyklus.', 'research.open': 'Forschung öffnen', 'research.treeHint': 'Ziehen / scrollen zum Erkunden', 'research.centerTree': 'Forschungsbaum zentrieren', 'research.resetView': 'Baumansicht zurücksetzen', 'research.treeRegion': 'Verschiebbarer Forschungsbaum. Mit den Pfeiltasten navigieren.',
...
const AR: Partial<Record<TranslationKey, string>> = {
  ...
  'research.title': 'ابتكارات الوكر', 'research.eyebrow': 'البحث', 'research.copy': 'حوّل الفطر والأدوات المسروقة والطقوس المشبوهة إلى مكاسب ثابتة لهذه الدورة.', 'research.open': 'فتح البحث', 'research.treeHint': 'اسحب / مرّر للاستكشاف', 'research.centerTree': 'توسيط شجرة البحث', 'research.resetView': 'إعادة ضبط عرض الشجرة', 'research.treeRegion': 'شجرة بحث قابلة للسحب. استخدم مفاتيح الأسهم للتحريك.',
...
const TR: Partial<Record<TranslationKey, string>> = {
  ...
  'research.title': 'İn Yenilikleri', 'research.eyebrow': 'Araştırma', 'research.copy': 'Mantarları, çalıntı aletleri ve şüpheli ritüelleri bu döngü için kalıcı kazançlara dönüştür.', 'research.open': 'Araştırmayı aç', 'research.treeHint': 'Keşfetmek için sürükle / kaydır', 'research.centerTree': 'Araştırma ağacını ortala', 'research.resetView': 'Ağaç görünümünü sıfırla', 'research.treeRegion': 'Sürüklenebilir araştırma ağacı. Kaydırmak için ok tuşlarını kullan.',
