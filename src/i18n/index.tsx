...
const EN = {
  ...
  'moonDial.actions': 'Lunar operations',
  'moonDial.tuning': 'Mooncap attunement',
  'moonDial.full': 'Reservoir full',
  'moonDial.ready': 'Charge available',
  ...
  'prestige.cosmeticsShop': 'Goblin Cosmetics',
  'prestige.cosmeticsHint': 'Spend permanent Ancestral Cunning on appearances that survive every New Warren.',
  'cosmetics.title': 'Goblin Cosmetics',
  'cosmetics.subtitle': 'Permanent wardrobe · suspiciously stylish bloodline',
  'cosmetics.currentLook': 'Currently equipped',
  'cosmetics.permanentHint': 'Owned appearances survive every Great Migration.',
  'cosmetics.cunning': 'Ancestral Cunning',
  'cosmetics.currencyAria': '{amount} Ancestral Cunning available',
  'cosmetics.wardrobe': 'Permanent wardrobe',
  'cosmetics.collection': 'Choose Your Goblin',
  'cosmetics.ownedHint': 'Buy once · equip whenever you like',
  'cosmetics.defaultName': 'Classic Goblin',
  'cosmetics.defaultDescription': 'The original warren look. Free, familiar, and permanently available.',
  'cosmetics.defaultTag': 'Default',
  'cosmetics.owned': 'Owned',
  'cosmetics.equipped': 'Equipped',
  'cosmetics.equip': 'Equip',
  'cosmetics.unequip': 'Unequip',
  'cosmetics.buy': 'Buy',
  'cosmetics.purchasedTitle': 'Cosmetic acquired',
  'cosmetics.purchasedMessage': '{name} is now part of the permanent bloodline wardrobe.',
  ...
  'save.otherTabTitle': 'This save is active in another tab.',
  'save.otherTabTakeOver': 'The other tab released or lost its lease. Reload the latest save to continue here.',
  'save.otherTabReadOnly': 'This tab is read-only so two copies cannot generate or overwrite the same progress.',
  'save.takeOver': 'Take over save',
  'save.otherTabActive': 'Other tab is active',
...
const ES: Partial<Record<TranslationKey, string>> = {
 ...
 'save.otherTabTitle': 'Esta partida está activa en otra pestaña.', 'save.otherTabTakeOver': 'La otra pestaña liberó o perdió su turno. Recarga la partida más reciente para continuar aquí.', 'save.otherTabReadOnly': 'Esta pestaña es de solo lectura para que dos copias no generen ni sobrescriban el mismo progreso.', 'save.takeOver': 'Tomar el control', 'save.otherTabActive': 'La otra pestaña está activa',
};
...
const ZH: Partial<Record<TranslationKey, string>> = {
 ...
 'save.otherTabTitle': '该存档正在另一个标签页中使用。', 'save.otherTabTakeOver': '另一个标签页已释放或失去了控制权。重新载入最新存档即可在此继续。', 'save.otherTabReadOnly': '此标签页为只读，以免两份副本同时生成或覆盖同一进度。', 'save.takeOver': '接管存档', 'save.otherTabActive': '另一个标签页正在使用',
};
...
const FR: Partial<Record<TranslationKey, string>> = {
 ...
 'save.otherTabTitle': 'Cette sauvegarde est active dans un autre onglet.', 'save.otherTabTakeOver': 'L’autre onglet a libéré ou perdu son bail. Rechargez la sauvegarde la plus récente pour continuer ici.', 'save.otherTabReadOnly': 'Cet onglet est en lecture seule afin que deux copies ne produisent ni n’écrasent la même progression.', 'save.takeOver': 'Reprendre la sauvegarde', 'save.otherTabActive': 'L’autre onglet est actif',
};
...
const DE: Partial<Record<TranslationKey, string>> = {
 ...
 'save.otherTabTitle': 'Dieser Spielstand ist in einem anderen Tab aktiv.', 'save.otherTabTakeOver': 'Der andere Tab hat seine Sperre freigegeben oder verloren. Lade den neuesten Spielstand, um hier weiterzuspielen.', 'save.otherTabReadOnly': 'Dieser Tab ist schreibgeschützt, damit nicht zwei Kopien denselben Fortschritt erzeugen oder überschreiben.', 'save.takeOver': 'Spielstand übernehmen', 'save.otherTabActive': 'Anderer Tab ist aktiv',
};
...
const AR: Partial<Record<TranslationKey, string>> = {
 ...
 'save.otherTabTitle': 'هذا الحفظ نشط في تبويب آخر.', 'save.otherTabTakeOver': 'حرر التبويب الآخر سيطرته أو فقدها. أعد تحميل أحدث حفظ للمتابعة هنا.', 'save.otherTabReadOnly': 'هذا التبويب للقراءة فقط حتى لا تنتج نسختان التقدم نفسه أو تكتب إحداهما فوق الأخرى.', 'save.takeOver': 'الاستحواذ على الحفظ', 'save.otherTabActive': 'التبويب الآخر نشط',
};
...
const TR: Partial<Record<TranslationKey, string>> = {
 ...
 'save.otherTabTitle': 'Bu kayıt başka bir sekmede etkin.', 'save.otherTabTakeOver': 'Diğer sekme kilidi bıraktı veya kaybetti. Burada devam etmek için en son kaydı yeniden yükleyin.', 'save.otherTabReadOnly': 'İki kopyanın aynı ilerlemeyi üretmesini veya üzerine yazmasını önlemek için bu sekme salt okunur.', 'save.takeOver': 'Kaydı devral', 'save.otherTabActive': 'Diğer sekme etkin',
};
...
const LANGUAGE_META = Object.fromEntries(LANGUAGE_OPTIONS.map((option) => [option.code, option])) as Record<LanguageCode, (typeof LANGUAGE_OPTIONS)[number]>;

export function getLanguageMeta(language: LanguageCode) {
  return LANGUAGE_META[language] ?? LANGUAGE_OPTIONS[0];
}
...
export function formatCompact(language: LanguageCode, value: number): string {
  ...
  return numberFormatter(getLanguageMeta(language).locale, {
