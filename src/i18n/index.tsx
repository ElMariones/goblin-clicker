...
const ES: Partial<Record<TranslationKey, string>> = {
  ...
  'upgrade.title': 'Innovaciones de la Madriguera', 'upgrade.subtitle': 'Mejoras permanentes durante este ciclo de cría.', 'upgrade.researchedSummary': '{done} / {total} investigadas', 'upgrade.researched': 'Investigado', 'upgrade.unknown': 'Desconocido', 'upgrade.common': 'Común', 'upgrade.veteran': 'Veterano', 'upgrade.advanced': 'Avanzado', 'upgrade.forbidden': 'Prohibido', 'upgrade.available': '{amount} goblins disponibles', 'upgrade.purchased': 'Innovación adquirida.', 'upgrade.genericDescription': 'Una mejora práctica que dura hasta la próxima Gran Migración.', 'upgrade.effectClick': 'Creación manual ×{multiplier}', 'upgrade.effectAll': 'Toda la producción ×{multiplier}', 'upgrade.effectBuilding': '{name} ×{multiplier}', 'upgrade.effectCps': 'Los clics obtienen +{percent}% de la producción base',
